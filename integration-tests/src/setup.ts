...
export async function setupCommon(
    ...
    const registryClient = new RegistryClient(client, localosmosis.addresses.wallet1, registry);
    await registryClient.stakeDenom({ numStakes: 1 }, "auto", undefined, [coin("10000", auto)]);
